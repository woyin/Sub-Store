...
// Proxy represents a unified proxy node structure used internally.
type Proxy struct {
	...
	Raw              map[string]interface{} `json:"-"` // unexported raw fields from parsing
}

// MapGetString returns a string value from a map[string]interface{}.
...
// MapGetBool returns a bool value from a map[string]interface{}.
...
// MapGetInt returns an int value from a map[string]interface{}.
...
// MapGetStringSlice returns a []string from a map value.
...
// MapGetIntSlice returns a []int from a map value.
...
// CloneMap deep-clones a map[string]interface{}.
...
// ProxyFromMap creates a Proxy from a raw map by converting through JSON.
...
// ToMap converts a Proxy to a raw map by converting through JSON.
...
// HasNonBlankValue checks if the proxy has a non-blank value for a field.
